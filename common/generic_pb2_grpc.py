...
class DBGenericStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Insert = channel.unary_unary(
                ...
                response_deserializer=generic__pb2.protobuf_server_response.FromString,
                )
...
def add_DBGenericServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Insert': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=generic__pb2.protobuf_server_response.SerializeToString,
            ),
...
class DBGeneric(object):
    ...
    def Insert(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/DBGeneric/Insert',
            ...
            generic__pb2.protobuf_server_response.FromString,
